...
set -v
ARGS="--txpool.globalslots 20000 --txpool.globalqueue 20000 --istanbul.blockperiod 1 --syncmode full --mine --rpc --rpcaddr localhost --rpccorsdomain "*" --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul "
